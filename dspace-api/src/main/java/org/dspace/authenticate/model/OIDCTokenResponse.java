 ...
 * 
 * {
 *   "access_token": "eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCIsIm9yZ...",
 *   "id_token": "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGki...",
 *   "token_type": "bearer",
 *   "expires_in": 28800,
 *   "scope": "pgc-role email openid profile"
 * }
 * 
...
public class OIDCTokenResponse {
     ...
     * this is the most relevant item, because it allow the server
     * to access to the user resources as defined in the scopes
