...
//            .withRelationDataset("DataSet")
    ...
    public void testOrgUnitCerifXmlDisseminate() throws Exception {
        ...
        ItemBuilder.createItem(context, collection)
            .withEntityType("Person")
            .withTitle("Walter White")
            .withSubjectOCDE("oecd::Ciencias sociales::Ciencias políticas::Administración pública")
            .withPersonMainAffiliationName("Test OrgUnit", orgUnit.getID().toString())
            .build();
    ...
    public void testEquipmentPerucrisCerifXmlDisseminate() throws Exception {
        ...
        Item equipment = ItemBuilder.createItem(context, collection)
            ...
            .withEquipmentOwnerPerson("Walter White")
            .withUsageType("Investigacion cientifica y desarrollo experimental")
            .withSubjectOCDE("oecd::Humanidades::Lenguas, Literatura::Literaturas específicas")
            .withSubjectOCDE("oecd::Ciencias sociales::Ciencias políticas::Teoría organizacional")
            .withResearchLine("ResearchLine")
            .withRelationFunding("Funding")
            .withManufacturingCountry("IT")
            .withManufacturingDate("2020-01-01")
    ...
    public void testInstitutionPatentPerucrisCerifXmlDisseminate() throws Exception {
        ...
        Item patent = ItemBuilder.createItem(context, collection)
            ...
            .withType("Controlled Vocabulary for Resource Type Genres::patent::PCT application")
    ...
    public void testPatentCerifXmlDisseminate() throws Exception {
        ...
        Item patent = ItemBuilder.createItem(context, collection)
            ...
            .withTitle("Test patent")
            .withType("Controlled Vocabulary for Resource Type Genres::patent::patente de diseño")
    ...
    public void testManyPatentsCerifXmlDisseminate() throws Exception {
        ...
        Item firstPatent = ItemBuilder.createItem(context, collection)
            .withEntityType("Patent")
            .withTitle("Test patent")
            .withType("Controlled Vocabulary for Resource Type Genres::patent::design patent")
            .withIssueDate("2021-01-01")
            .withPublisher("Publisher")
            .withPatentNo("12345-666")
            .build();
        ...
        Item secondPatent = ItemBuilder.createItem(context, collection)
            ...
            .withType("Controlled Vocabulary for Resource Type Genres::patent::Solicitud PCT")
    ...
    public void testManyPatentsPerucrisCerifXmlDisseminate() throws Exception {
        ...
        Item firstPatent = ItemBuilder.createItem(context, collection)
            .withEntityType("Patent")
            .withTitle("Test patent")
            .withType("Controlled Vocabulary for Resource Type Genres::patent::patente de plantas")
            .withDateSubmitted("2021-01-01")
            .withPublisher("Publisher")
            .withPatentNo("12345-666")
            .build();
        ...
        Item secondPatent = ItemBuilder.createItem(context, collection)
            .withEntityType("Patent")
            .withTitle("Second patent")
            .withType("Controlled Vocabulary for Resource Type Genres::patent::obtención de variedades vegetales")
