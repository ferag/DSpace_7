...
/**
 * Implementation of {@link AccessItemMode} to configure the item reinstate
 * modes.
 *
 * @author Luca Giamminonni (luca.giamminonni at 4science.it)
 *
 */
public class ReinstateItemMode implements AccessItemMode {

    /**
     * Defines the users enabled to use this reinstate configuration
     */
