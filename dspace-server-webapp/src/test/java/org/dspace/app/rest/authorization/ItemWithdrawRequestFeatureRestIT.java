...
public class ItemWithdrawRequestFeatureRestIT extends AbstractControllerIntegrationTest {
    ...
    private AuthorizationFeature canWithdrawItem;
    ...
    @Test
    public void testFeatureWithWithdrawDisabled() throws Exception {
        ...
        configurationService.setProperty("item-withdrawn.enabled", false);
    ...
    public void testFeatureWithAdmin() throws Exception {
        ...
        configurationService.setProperty("item-withdrawn.permit-all", false);

        String token = getAuthToken(admin.getEmail(), password);

        Authorization expectedAuthorization = new Authorization(admin, canWithdrawItem, itemRest);
    ...
    public void testFeatureWithPermitAllEnabled() throws Exception {
        ...
        Authorization expectedAuthorization = new Authorization(eperson, canWithdrawItem, itemRest);
